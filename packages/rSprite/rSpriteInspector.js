...
Vue.component("remotesprite", {
    template: `
        <ui-prop style="padding-top: 10px" name="Atlas" tooltip="{{T(\'COMPONENT.sprite.atlas\')}}">
            ...
            <ui-button class="blue tiny" tooltip="{{T(\'COMPONENT.sprite.select_tooltip\')}}" @confirm="selectAtlas">
        ...
        <ui-prop style="padding-top: 10px" name="Sprite Frame" tooltip="{{T(\'COMPONENT.sprite.sprite_frame\')}}">
            ...
            <ui-button class="blue tiny" tooltip="{{T(\'COMPONENT.sprite.edit_tooltip\')}}" @confirm="editSprite">
        ...
        <ui-prop v-prop="target.defaultURL" :multi-values="multi"></ui-prop>
        <cc-array-prop :target.sync="target.frameList"></cc-array-prop>
    `,
    props: {
        target: {
            twoWay: !0,
    ...
    methods: {
        ...
        _updateAtlas() {
            if (!this.target)
                return this.atlasUuid = "", this.atlasUuids = "", this.atlasMulti = !1, void 0;
        ...
        _updateSprite() {
            if (!this.target)
                return this.spriteUuid = "", this.spriteUuids = "", this.spriteMulti = !1, void 0;
