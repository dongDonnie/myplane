...
CampNormal228.data = {
    ...
    monsterWaves:[
        {groups:[68,61,16],refreshMap:{loopIndex:1,groupIndex:0,delay:2},refreshMode:{choose:0,wait:0,interval:1}},
        {groups:[92],refreshMap:{loopIndex:1,groupIndex:1,delay:2.5},refreshMode:{choose:0,wait:0,interval:0}},
        {groups:[38,41,77],refreshMap:{loopIndex:1,groupIndex:1,delay:4.5},refreshMode:{choose:0,wait:0,interval:1}},
        {groups:[44,35],refreshMap:{loopIndex:1,groupIndex:2,delay:0},refreshMode:{choose:0,wait:0,interval:0}},
        {groups:[51,52,21,27],refreshMap:{loopIndex:1,groupIndex:3,delay:0},refreshMode:{choose:0,wait:0,interval:2}},
