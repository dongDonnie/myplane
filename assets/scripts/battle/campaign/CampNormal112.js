...
CampNormal112.data = {
    ...
    monsterWaves:[
        {groups:[19,23,52,33],refreshMap:{loopIndex:1,groupIndex:0,delay:2},refreshMode:{choose:0,wait:0,interval:1}},
        {groups:[27],refreshMap:{loopIndex:1,groupIndex:1,delay:2.5},refreshMode:{choose:0,wait:0,interval:0}},
        {groups:[85],refreshMap:{loopIndex:1,groupIndex:1,delay:4.5},refreshMode:{choose:0,wait:0,interval:0}},
        {groups:[23,35,53],refreshMap:{loopIndex:1,groupIndex:2,delay:0},refreshMode:{choose:0,wait:0,interval:2}},
        {groups:[52,15],refreshMap:{loopIndex:1,groupIndex:3,delay:0},refreshMode:{choose:0,wait:0,interval:2}},
