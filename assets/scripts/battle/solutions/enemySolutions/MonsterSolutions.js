...
const MonsterSolutions = cc.Class({
    ...
    statics: {
        solution_1: function (info, speed, angle, speedacc, angleacc, SpfixDirection, Rotation, autoskilldelay, scale) {
            //直线
        ...
        solution_3: function (info, destination, time, overDes, fixDirection, autoskilldelay, scale) {
            ...
            entity.setTimerHandler(function (idx) {
                ...
                if (idx == 2) {
                    this.simpleHarmonic(10, 2, -90, cc.v2(1, 0), cc.v2(0, 0), cc.v2(0, 0), 0)
                    this.setMovementType(5);
                }
            });
            entity.setTimer(0, 0, 1, 0);
        ...
        solution_16: function (info, speed, speedacc, angleacc, SpfixDirection, autoskilldelay, scale) {
            ...
            let angle = ai.getAngle(pos, ai.getHero().getPosition());
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    if (SpfixDirection == 0) {
                        this.setSpeed(ai.speedTransfer(speed, angle), false);
        ...
        solution_17: function (info, speed, angle, speedacc, angleacc, direction, posPlus) {
            //导弹怪
            let ai = require('AIInterface');
            let entity = ai.createMonster(info);
            entity.addInvincibleTime(9999);
            entity.addMotionStreak('huoyan_jin');
            entity.setRotation(90 - angle);
            entity.setDropCrystal(false);
            entity.setCollisionSwitch(false);
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    this.setActive(false);
                    this.addEnemyIncoming(direction, posPlus);
                }
                if (idx == 1) {
                    this.destroyEnemyIncoming();
                    this.setActive(true);
                    this.setCollisionSwitch(true);
                    this.setSpeed(ai.speedTransfer(speed, angle), true);
                    this.setSpeedAcc(ai.speedTransfer(speedacc, angleacc));
        ...
        solution_18: function (info, skills) {
            ...
            let pos_1 = info.pos;
            let vec_1 = ai.posTransfer(pos_1);
            let vec_2 = ai.posTransfer(pos_1.add(cc.v2(-0.3125, 0.264)));
            let vec_3 = ai.posTransfer(pos_1.add(cc.v2(-0.3125, 0.96)));
            let vec_4 = ai.posTransfer(pos_1.add(cc.v2(0, 0.8)));
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    this.setCollisionSwitch(false);
                ...
                if (idx == 1) {
                    this.setCollisionSwitch(true);
                    this.simpleHarmonic(10, 2, -90, cc.v2(1, 0), cc.v2(0, 0), cc.v2(15, 15), 0)
                    this.setMovementType(5);
                    this.setCollisionSwitch(true);
                    this.setTimer(2, 2, 1, 0);
                }
                if (idx == 2) {
                    this.simpleHarmonic(10, 2, -90, cc.v2(1, 0), cc.v2(30, 30), cc.v2(-15, -15), 0)
                    this.setMovementType(5);
        ...
        solution_19: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    let destination = ai.posTransfer(cc.v2(0.5, 0.8));
                ...
                if (idx == 10) {
                    let destination = ai.posTransfer(cc.v2(0.2, 0.8));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(11, 2, 1, 0);
                }
                if (idx == 11) {
                    let destination = ai.posTransfer(cc.v2(0.55, 0.8));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(1, 2, 1, 0);
                }
                if (idx == 12) {
                    let destination = ai.posTransfer(cc.v2(0.8, 0.8));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(13, 2, 1, 0);
                }
        ...
        solution_20: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    ai.setMonsterLoopAction(this, 'daiji_1')
                    let destination = ai.posTransfer(cc.v2(0.5, 0.75));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setCollisionSwitch(false);
                ...
                if (idx == 4) {
                    ...
                    this.simpleHarmonic(50, 4, 90, cc.v2(0, 1), cc.v2(0, -30), cc.v2(0, 0), 0)
                    this.setMovementType(5);
                ...
                if (idx == 6) {
                    this.simpleHarmonic(200, 8, 90, cc.v2(0, 1), cc.v2(0, 0), cc.v2(0, 0), 0)
                    this.setMovementType(5);
                ...
                if (idx == 10) {
                    ...
                    if (num < 2) {
                        ...
                        ai.playAction(this, 'start_2', false, cb);
                    }
                    else {
                        this.setTimer(11, 2, 1, 0);
                    }
                ...
                if (idx == 13) {
                    ai.playAction(this, 'attack_1', false, cb);
                    ai.useSkill(this, 839);
                }
                if (idx == 14) {
                ...
                if (idx == 15) {
                    let destination = ai.posTransfer(cc.v2(0.3, 0.6));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                ...
                if (idx == 17) {
                    let destination = ai.posTransfer(cc.v2(0.7, 0.8));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                ...
                if (idx == 18) {
                    ...
                    this.setTimer(19, 6, 1, 0);
                }
                if (idx == 19) {
                    let destination = ai.posTransfer(cc.v2(0.5, 0.85));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
        ...
        solution_21: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    this.setCollisionSwitch(false);
                    this.simpleHarmonic(250, 4, 90, cc.v2(1, 0), cc.v2(0, 0), cc.v2(0, 0), 0)
                    this.setMovementType(5);
                    this.runScale(1.5, 2);
                    this.setTimer(1, 2, 1, 0);
                }
                ...
                if (idx == 6) {
                    let destination = ai.posTransfer(cc.v2(0.5, 0.5));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(7, 1.7, 1, 0);
                }
                if (idx == 7) {
                    ai.addAction(this, 'attack1', 2);
                    ai.useSkill(this, 822);
                    this.setTimer(8, 4, 1, 0);
                }
                if (idx == 8) {
                    let destination = ai.posTransfer(cc.v2(0.5, 0.7));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
        ...
        solution_22: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                ...
                if (idx == 3) {
                    let destination = ai.posTransfer(cc.v2(0.8, 0.6));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
        ...
        solution_23: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    this.setCollisionSwitch(false);
                    let destination = ai.posTransfer(cc.v2(0.5, 0.65));
                ...
                if (idx == 1) {
                    this.setCollisionSwitch(true);
                    ai.playAction(this, 'bianxing', false, cb);
                    this.setTimer(3, 0, 1, 0);
                }
                if (idx == 2) {
                    ai.playAction(this, 'daiji', 1);
                }
                if (idx == 3) {
                    let pos = this.getPosition();
                    let circlePos = pos.add(ai.speedTransfer(30, 90))
                ...
                if (idx == 5) {
                    ...
                    this.simpleHarmonic(250, 8, 90, cc.v2(0, 1), cc.v2(0, 0), cc.v2(0, 0), 0)
                    this.setMovementType(5);
                ...
                if (idx == 9) {
                    ai.playAction(this, 'gongji_1_start', false, cb);
                }
                if (idx == 10) {
                    ai.playAction(this, 'gongji_1_loop', 1);
                    this.setTimer(11, 1, 1, 0);
                }
                if (idx == 11) {
                    ai.useSkill(this, 830);
                    let destination = ai.posTransfer(cc.v2(0.5, 1.4));
                    this.shiftToStandby(destination, 3, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(12, 3, 1, 0);
                }
                if (idx == 12) {
                    let HeroPos = ai.getHero().getPosition();
                    this.setPosition(ai.posTransfer(cc.v2(HeroPos.x / 640, 1.4)));
                    let destination = ai.posTransfer(cc.v2(HeroPos.x / 640, -0.4));
                ...
                if (idx == 13) {
                    ...
                    this.setPosition(ai.posTransfer(cc.v2(HeroPos.x / 640, -0.4)));
                    let destination = ai.posTransfer(cc.v2(HeroPos.x / 640, 1.4));
                    this.shiftToStandby(destination, 2, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(14, 2, 1, 0);
                }
                if (idx == 14) {
                    this.setRotation(0);
                    this.setPosition(ai.posTransfer(cc.v2(0.5, 1.4)));
                    let destination = ai.posTransfer(cc.v2(0.5, 0.65));
                    this.shiftToStandby(destination, 3, 30, 0);
                    this.setMovementType(4);
                ...
                if (idx == 15) {
                    ai.playAction(this, 'gongji_1_end', false, cb);
                }
                if (idx == 16) {
                    ai.playAction(this, 'daiji', 1);
                    this.setTimer(3, 0, 1, 0);
        ...
        solution_24: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                ...
                if (idx == 1) {
                    this.setCollisionSwitch(true);
                    ai.playAction(this, 'bianxing_1', false, cb);
                }
                if (idx == 2) {
                    ai.playAction(this, 'putong', 1);
                    this.setTimer(3, 1, 1, 0);
                }
                if (idx == 3) {
                ...
                if (idx == 5) {
                    ...
                    let monsterInfo_1 = {
                        mId: 1471,
                        lv: this.lv,
                        pos: cc.v2(this.getPosition().x/cc.winSize.width,this.getPosition().y/cc.winSize.height),
                    };
                    let monsterInfo_2 = {
                        mId: 1472,
                        lv: this.lv,
                ...
                if (idx == 6) {
                    this.setCollisionSwitch(true);
                    ai.playAction(this, 'bianxing_2', false, cb);
                    ai.useSkill(this, 25);
                }
                if (idx == 7) {
                    ai.playAction(this, 'daiji', 1);
        ...
        solution_25: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                ...
                if (idx == 5) {
                    ...
                    this.simpleHarmonic(250, 2, 90, cc.v2(0, -1), cc.v2(0, 0), cc.v2(0, 0), 0)
                    this.setMovementType(5);
                ...
                if (idx == 11) {
                    let destination = ai.posTransfer(cc.v2(0.25, 0.65));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                ...
                if (idx == 13) {
                    let destination = ai.posTransfer(cc.v2(0.75, 0.65));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                ...
                if (idx == 14) {
                    ai.useSkill(this, 43);
                    this.simpleHarmonic(50, 2, 90, cc.v2(0, -1), cc.v2(0, 0), cc.v2(0, 0), 0)
                    this.setMovementType(5);
                    this.setTimer(15, 1, 1, 0);
                }
                if (idx == 15) {
                    let destination = ai.posTransfer(cc.v2(0.25, 0.6));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(16, 1, 1, 0);
                }
                ...
                if (idx == 17) {
                    let destination = ai.posTransfer(cc.v2(0.75, 0.7));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(18, 1, 1, 0);
                }
                ...
                if (idx == 27) {
                    ai.playAction(this, 'idle2', 1);
                    ai.useSkill(this, 857);
                    this.simpleHarmonic(250, 4, 90, cc.v2(0, -1), cc.v2(0, 0), cc.v2(0, 0), 0)
                    this.setMovementType(5);
                ...
                if (idx == 29) {
                    ...
                    ai.useSkill(this, 856);
                    let destination = ai.posTransfer(cc.v2(0.4, 0.65));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(30, 1, 1, 0);
                }
                if (idx == 30) {
                    let destination = ai.posTransfer(cc.v2(0.6, 0.55));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(31, 1, 1, 0);
                }
                if (idx == 31) {
                    let destination = ai.posTransfer(cc.v2(0.8, 0.75));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
        ...
        solution_26: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    this.setCollisionSwitch(false);
                    let destination = ai.posTransfer(cc.v2(0.5, 0.65));
                    this.shiftToStandby(destination, 2, 50, 0);
                    this.setMovementType(4);
                    this.setTimer(1, 2, 1, 0);
                }
                if (idx == 1) {
                ...
                if (idx == 3) {
                    this.setCollisionSwitch(false);
                    let destination = ai.posTransfer(cc.v2(0.5, 0.7));
                    this.shiftToStandby(destination, 1, 50, 0);
                    this.setMovementType(4);
                    this.setTimer(4, 1, 1, 0);
                }
                if (idx == 4) {
                ...
                if (idx == 5) {
                    let destination = ai.posTransfer(cc.v2(0.3, 0.75));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(6, 1, 1, 0);
                }
                ...
                if (idx == 9) {
                    let destination = ai.posTransfer(cc.v2(0.7, 0.75));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(10, 1, 1, 0);
                }
                ...
                if (idx == 25) {
                    ai.playAction(this, 'idle_2', 1);
                    this.setCollisionSwitch(true);
                    this.runScale(0.5, 0.5);
                    let destination = ai.posTransfer(cc.v2(cc.v2(0.2 + 0.6 * Math.random(), 0.5 + 0.3 * Math.random())));
                    this.shiftToStandby(destination, 0.5, 5, 0);
                    this.setMovementType(4);
                    this.setTimer(26, 0.5, 9999, 0);
                    this.setTimer(27, 3, 1, 0);
                }
                if (idx == 26) {
                    let destination = ai.posTransfer(cc.v2(cc.v2(0.2 + 0.6 * Math.random(), 0.5 + 0.3 * Math.random())));
                    this.shiftToStandby(destination, 0.5, 5, 0);
        ...
        solution_28: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                ...
                if (idx == 2) {
                    this.setCollisionSwitch(true);
                    ai.playAction(this, 'idle', 1);
                    let destination = ai.posTransfer(cc.v2(0.2, 0.75));
                ...
                if (idx == 3) {
                    let destination = ai.posTransfer(cc.v2(0.4, 0.75));
                ...
                if (idx == 4) {
                    ...
                    this.setMovementType(4);
                    this.setTimer(5, 3.5, 1, 0);
                }
                if (idx == 5) {
                    let destination = ai.posTransfer(cc.v2(0.9, 0.75));
                    this.shiftToStandby(destination, 0.5, 0, 0);
                    this.setMovementType(4);
                    this.setTimer(6, 0.5, 1, 0);
                }
                if (idx == 6) {
                    let destination = ai.posTransfer(cc.v2(0.75, 0.75));
                    this.shiftToStandby(destination, 1, 0, 0);
                    this.setMovementType(4);
                    this.setTimer(7, 2, 1, 0);
                }
                if (idx == 7) {
                    let destination = ai.posTransfer(cc.v2(0.25, 0.75));
                    this.shiftToStandby(destination, 3, 0, 0);
                    this.setMovementType(4);
                    this.setTimer(8, 4, 1, 0);
                }
                if (idx == 8) {
                    let destination = ai.posTransfer(cc.v2(0.1, 0.75));
                    this.shiftToStandby(destination, 1, 0, 0);
                    this.setMovementType(4);
                    this.setTimer(9, 1, 1, 0);
                }
        ...
        solution_29: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    ...
                    ai.setMonsterLoopAction(this, 'start');
                    let destination = ai.posTransfer(cc.v2(0.5, 0.75));
                    this.shiftToStandby(destination, 0.5, 15, 0);
                    this.setMovementType(4);
                    this.setTimer(1, 0.5, 1, 0);
                }
                if (idx == 1) {
                    this.setCollisionSwitch(true);
                    ai.playAction(this, 'attack', false, cb);
                }
                if (idx == 2) {
                    ai.useSkill(this, 21);
                    this.setTimer(3, 2, 1, 0);
        ...
        solution_31: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                ...
                if (idx == 2) {
                    ai.playAction(this, 'daiji_01', 1);
                    this.setTimer(3, 1, 1, 0);
                }
                if (idx == 3) {
                    this.setCollisionSwitch(true);
                    let destination = ai.posTransfer(cc.v2(0.25, 0.8));
                    this.shiftToStandby(destination, 1, 15, 0);
                    this.setMovementType(4);
                    this.setTimer(4, 1, 1, 0);
                }
                ...
                if (idx == 10) {
                    let destination = ai.posTransfer(cc.v2(0.75, 0.8));
                    this.shiftToStandby(destination, 1, 15, 0);
                    this.setMovementType(4);
                    this.setTimer(11, 1, 1, 0);
                }
                ...
                if (idx == 22) {
                    ...
                    let destination = ai.posTransfer(cc.v2(0.6, 0.75));
                    this.shiftToStandby(destination, 1, 15, 0);
                    this.setMovementType(4);
                ...
                if (idx == 24) {
                    let destination = ai.posTransfer(cc.v2(0.4, 0.7));
                    this.shiftToStandby(destination, 1, 15, 0);
                    this.setMovementType(4);
                    this.setTimer(25, 1, 1, 0);
                }
                ...
                if (idx == 27) {
                    this.simpleHarmonic(100, 2, 90, cc.v2(1, 0), cc.v2(0, 0), cc.v2(0, 0), 0)
                    this.setMovementType(5);
                    this.setTimer(28, 0.5, 1, 0);
                }
                if (idx == 28) {
                    ai.playAction(this, 'gongji_2_start', 1);
                ...
                if (idx == 31) {
                    ...
                    this.shiftToStandby(destination, 0.5, 0, 0);
                    this.setMovementType(4);
                    this.setTimer(32, 0.5, 1, 0);
                }
                if (idx == 32) {
                    ai.playAction(this, 'gongji_2_end', false, cb);
                }
                if (idx == 33) {
                    ai.playAction(this, 'daiji_02', 1);
                ...
                if (idx == 39) {
                    ...
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(40, 1, 1, 0);
                }
                if (idx == 40) {
                    ai.playAction(this, 'bianxing_3', false, cb);
                }
                if (idx == 41) {
                    ai.playAction(this, 'daijia_03', 1);
                ...
                if (idx == 44) {
                    ...
                    this.setTimer(48, 9, 1, 0);
                }
                if (idx == 45) {
                    this.setSpeed(cc.v2(0, 0));
                    this.setMovementType(0);
                    this.setPosition(ai.posTransfer(cc.v2(0.25 + 0.5 * Math.random(), 0.5 + 0.3 * Math.random())));
                ...
                if (idx == 20) {
                    this.setTimer(46, 2, 2, 1);
                }
                if (idx == 46) {
                    num += 1;
                    if (num % 2 !== 0) {
                        this.opacity = (255);
                        ai.playAction(this, 'gongji_3_loop', 1);
                        this.setPosition(ai.posTransfer(cc.v2(-0.1, 1.1)));
                        let destination = ai.posTransfer(cc.v2(1.6, 0.1));
                        this.shiftToStandby(destination, 1.5, 0, 1);
                        this.setMovementType(4);
                    ...
                    if (num % 2 == 0) {
                        this.opacity = (255);
                        ai.playAction(this, 'gongji_3_loop', 1);
                        this.setPosition(ai.posTransfer(cc.v2(1.1, 1.1)));
                        let destination = ai.posTransfer(cc.v2(-0.6, 0.1));
                        this.shiftToStandby(destination, 1.5, 0, 1);
                        this.setMovementType(4);
                        this.setTimer(47, 0.4, 4, 0);
                    }
                ...
                if (idx == 48) {
                    this.setRotation(0);
                    this.setPosition(ai.posTransfer(cc.v2(0.5, 1.1)));
                    let destination = ai.posTransfer(cc.v2(0.5, 0.75));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(49, 1, 1, 0);
                }
                if (idx == 49) {
                    ai.playAction(this, 'daiji_03', 1);
                    ai.useSkill(this, 888);
                    this.simpleHarmonic(100, 8, 90, cc.v2(0, 1), cc.v2(0, 0), cc.v2(0, 0), 0)
                    this.setMovementType(5);
        ...
        solution_32: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    ...
                    let vec_1 = ai.posTransfer(pos_1.add(cc.v2(0.3, 0.4)));
                    let vec_2 = ai.posTransfer(pos_1.add(cc.v2(0.3, 1.2)));
                    let vec_3 = ai.posTransfer(pos_1.add(cc.v2(0, 1.2)));
                    let vec_4 = ai.posTransfer(pos_1.add(cc.v2(-0.3, 1.1)));
                    let vec_5 = ai.posTransfer(pos_1.add(cc.v2(-0.15, 0.7)));
                    let vec_6 = ai.posTransfer(pos_1.add(cc.v2(0, 0.9)));
                ...
                if (idx == 3) {
                    ...
                    let destination = ai.posTransfer(cc.v2(0.65, 0.6));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(4, 2, 1, 0);
                }
                ...
                if (idx == 10) {
                    ai.playAction(this, 'bs_1', false, cb);
                    ai.useSkill(this, 892);
                    this.setTimer(12, 0.5, 1, 0);
                }
                if (idx == 11) {
                    ai.setMonsterLoopAction(this, 'start_2');
                    ai.playAction(this,'start_2',1);
                    this.setTimer(13, 1, 1, 0);
                }
                if (idx == 12) {
                ...
                if (idx == 13) {
                    ...
                    let destination = ai.posTransfer(cc.v2(0.85, 0.75));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(14, 2, 1, 0);
                }
                if (idx == 14) {
                    ...
                    let destination = ai.posTransfer(cc.v2(0.3, 0.7));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(15, 2, 1, 0);
                }
                if (idx == 15) {
                    ...
                    let destination = ai.posTransfer(cc.v2(0.5, 0.8));
                    this.shiftToStandby(destination, 0.5, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(16, 0.5, 1, 0);
                }
                if (idx == 16) {
                    ai.playAction(this, 'attack_1');
                ...
                if (idx == 17) {
                    let destination = ai.posTransfer(cc.v2(0.5, 0.6));
                    this.shiftToStandby(destination, 0.5, 10, 0);
                    this.setMovementType(4);
                ...
                if (idx == 19) {
                    let destination = ai.posTransfer(cc.v2(0.5, 1.3));
                    this.shiftToStandby(destination, 0.5, 0, 0);
                    this.setMovementType(4);
                    this.setTimer(20, 2, 1, 0);
                }
                if (idx == 20) {
                    let pos_1 = cc.v2(0.5, -0.3);
                    ...
                    let vec_4 = ai.posTransfer(pos_1.add(cc.v2(0.3, 1.1)));
                    let vec_5 = ai.posTransfer(pos_1.add(cc.v2(0.15, 0.7)));
                    let vec_6 = ai.posTransfer(pos_1.add(cc.v2(0, 1)));
                    let posData = [vec_0, vec_1, vec_2, vec_3, vec_4, vec_5, vec_6];
                    this.setBezier(posData, 1000, 0, 0);
                    this.setMovementType(2);
                ...
                if (idx == 21) {
                    ai.playAction(this, 'bs_2', false, cb);
                    ai.useSkill(this, 890);
                    let destination = ai.posTransfer(cc.v2(0.5, 0.75));
                    this.shiftToStandby(destination, 0.5, 0, 0);
                    this.setMovementType(4);
                ...
                if (idx == 23) {
                    ...
                    this.shiftToStandby(destination, 0.5, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(24, 1.5, 1, 0);
                }
                if (idx == 24) {
                    ai.useSkill(this, 890);
                    let destination = ai.posTransfer(cc.v2(0.75, 0.6));
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(25, 2, 1, 0);
                }
                if (idx == 25) {
                    ...
                    this.shiftToStandby(destination, 1, 30, 0);
                    this.setMovementType(4);
                    this.setTimer(26, 1.2, 1, 0);
                }
                if (idx == 26) {
                    let destination = ai.posTransfer(cc.v2(0.5, 0.6));
                    this.shiftToStandby(destination, 0.5, 10, 0);
                    this.setMovementType(4);
                    this.setTimer(27, 0.7, 1, 0);
                }
                if (idx == 27) {
        ...
        solution_33: function (monsterInfo) {
            ...
            entity_1.setTimerHandler(function (idx) {
                if (idx == 0) {
                    ai.setMonsterLoopAction(this, 'start_1');
                    let destination = ai.posTransfer(cc.v2(0.1 + Math.random() * 0.8, 0.2 + Math.random() * 0.4));
                    this.shiftToStandby(destination, 2, 10, 0);
                    this.setMovementType(4);
                    this.setTimer(1, 2, 1, 0);
                }
                if (idx == 1) {
        ...
        solution_34: function (info, skills) {
            ...
            entity_1.setTimerHandler(function (idx) {
                ...
                if (idx == 1) {
                    let pos = this.getPosition();
                    this.setPosition(pos.add(cc.v2(-80, 0)));
                    this.opacity = (255);
        ...
        solution_36: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                ...
                if(idx == 1){
                    this.setCollisionSwitch(true);
                    let destination = ai.posTransfer(cc.v2(0.65,0.65));
                ...
                if(idx == 5){
                    let destination = ai.posTransfer(cc.v2(0.5,0.55));
                    this.shiftToStandby(destination, 1, 5, 0);
                    this.setMovementType(4);
                    this.setTimer(6,1,1,0);
                }
                ...
                if(idx == 11){
                    this.setTimer(12,0.5,4,0);
                    this.setTimer(13,2,1,0);
                    this.setTimer(14,0.5,3,0);
                }
                if(idx == 12){
                    let destination = ai.posTransfer(cc.v2(0.25+Math.random()*0.5,0.4+Math.random()*0.3));
                    this.shiftToStandby(destination, 0.5, 5, 0);
                    this.setMovementType(4);
                }
                if(idx == 13){
                ...
                if(idx == 23){
                    ...
                    MonsterSolutions.solution_37(Info_1);
                    MonsterSolutions.solution_37(Info_2);
                }
            });
            entity.setTimer(0, 0, 1, 0);
            return entity;
        ...
        solution_65: function (info, Scale, D) {
            ...
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    this.setCollisionSwitch(false);
                    this.simpleHarmonic(100, 4, 90, cc.v2(1, 0), cc.v2(0, 0), cc.v2(0, 0), 0)
                    this.setMovementType(5);
                ...
                if (idx == 2) {
                    ...
                    let destination = cc.v2(x, y);
                    this.shiftToStandby(destination, 2.5, 5, 0);
                    this.setMovementType(4);
        ...
        solution_66: function (info, skills) {
            //导弹怪_向右
            return MonsterSolutions.solution_17(info, 1400, 0, 0, 0, cc.v2(1, 0));
        },
        solution_67: function (info, skills) {
            //导弹怪_向左
            return MonsterSolutions.solution_17(info, 1400, 180, 0, 0, cc.v2(-1, 0));
        },
        ...
        solution_69: function (info, skills) {
            //导弹怪_向下
            return MonsterSolutions.solution_17(info, 1400, -90, 0, 0);
        },
        //70-   关卡ai
        ...
        solution_72: function (info, skills) {
            return MonsterSolutions.solution_1(info, 400, -90, 0, 0, 1);
        },
        ...
        solution_83: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_5(info, 300, 0, pos, cc.v2(1, 0), cc.v2(1, 0.5), 1, 1);
        },
        ...
        solution_87: function (info, skills) {
            let ai = require('AIInterface');
            let vec = ai.posTransfer(info.pos.add(cc.v2(0.5, 0)));
            return MonsterSolutions.solution_3(info, vec, 2, 50, 0, 3);
        },
        ...
        solution_89: function (info, skills) {
            let ai = require('AIInterface');
            let vec = ai.posTransfer(info.pos.add(cc.v2(0, -0.5)));
            return MonsterSolutions.solution_3(info, vec, 2, 50, 0, 3);
        },
        ...
        solution_99: function (info, skills) {
            return MonsterSolutions.solution_2(info, 300, 0, 0, 0, 1, 50, 4, 90, cc.v2(0, 1), cc.v2(0, 0), cc.v2(0, 0), 0, 0.5, 1);
        },
        solution_100: function (info, skills) {
            return MonsterSolutions.solution_2(info, 300, 180, 0, 0, 1, 50, 4, 90, cc.v2(0, -1), cc.v2(0, 0), cc.v2(0, 0), 0, 0.5, 1);
        },
        solution_101: function (info, skills) {
            return MonsterSolutions.solution_2(info, 300, -90, 0, 0, 2, 50, 4, 90, cc.v2(0, 1), cc.v2(0, 0), cc.v2(0, 0), 0, 0.5, 1);
        },
        solution_102: function (info, skills) {
            return MonsterSolutions.solution_2(info, 300, 30, 0, 0, 1.3, 50, 4, 90, cc.v2(0, 1), cc.v2(0, 0), cc.v2(0, 0), 0, 0.5, 1);
        },
        solution_103: function (info, skills) {
            return MonsterSolutions.solution_2(info, 300, 150, 0, 0, 1.3, 50, 4, 90, cc.v2(0, 1), cc.v2(0, 0), cc.v2(0, 0), 0, 0.5, 1);
        },
        ...
        solution_106: function (info, skills) {
            return MonsterSolutions.solution_2(info, 300, -45, 0, 0, 1.5, 50, 4, 90, cc.v2(0, 1), cc.v2(0, 0), cc.v2(0, 0), 0, 0.5, 1);
        },
        solution_107: function (info, skills) {
            return MonsterSolutions.solution_2(info, 300, -135, 0, 0, 1.5, 50, 4, 90, cc.v2(0, 1), cc.v2(0, 0), cc.v2(0, 0), 0, 0.5, 1);
        },
        ...
        solution_111: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                ...
                if (idx == 1) {
                    ai.autoUseSkill(this, true);
                    this.setEntityAutoCircle(cc.v2(320, 800), pos.sub(cc.v2(320, 800)), 90, 0, 0, 0, 0);
                    this.setMovementType(1);
                }
            });
            entity.setTimer(0, 1, 1, 0);
        ...
        solution_113: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_6(info, 450, 0, pos, cc.v2(0.2031, -0.3521), cc.v2(0.8906, -0.3521), cc.v2(1.0938, 0), 1, 1);
        },
        ...
        solution_115: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_10(info, 450, 0, pos, cc.v2(-0.8312, -0.1601), cc.v2(-0.6006, -0.5408), cc.v2(0.2413, -0.3867), cc.v2(0.5094, -0.8399), cc.v2(-0.3486, -1), 0, 1);
        },
        ...
        solution_117: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_7(info, 450, 0, pos, cc.v2(0.362, 0.3266), cc.v2(0.4847, -0.5375), cc.v2(0.5368, 0.3318), cc.v2(1, 0), 0, 1);
        },
        ...
        solution_119: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_10(info, 450, 0, pos, cc.v2(-0.0615, -0.5677), cc.v2(0.5654, -0.0975), cc.v2(1.0654, -0.2817), cc.v2(-0.35, -0.7454), cc.v2(1, -0.8494), 1, 1);
        },
        ...
        solution_121: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_9(info, 450, 0, pos, cc.v2(0.5023, -0.0026), cc.v2(0.9862, 0.0441), cc.v2(1.2074, 0.2856), cc.v2(0.9493, 0.4907), cc.v2(0.318, 0.5504), cc.v2(-0.0968, 0.3505), cc.v2(0.1843, 0.244), cc.v2(-0.0369, 0.0441), cc.v2(0.5023, 0), cc.v2(1, -0.0026), 1, 1);
        },
        solution_122: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_9(info, 450, 0, pos, cc.v2(-0.4977, 0.0026), cc.v2(-1.039, 0.0467), cc.v2(-0.8157, 0.2466), cc.v2(-1.0968, 0.3531), cc.v2(-0.682, 0.553), cc.v2(-0.0507, 0.4933), cc.v2(0.2074, 0.2882), cc.v2(-0.0138, 0.0467), cc.v2(-0.4977, 0), cc.v2(-1, 0.0026), 1, 1);
        },
        solution_123: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_12(info, 450, 0, pos, cc.v2(1.3469, 0.0018), cc.v2(1.3469, 0.4525), cc.v2(1.0188, 0.6585), cc.v2(0.7656, 0.4507), cc.v2(0.9375, 0.2835), 0, 0.5);
        },
        ...
        solution_125: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_13(info, 350, 0, pos, cc.v2(1.1906, 0.3715), cc.v2(0.05, 0.3724), cc.v2(0.3828, 0.2289), 0, 0.5);
        },
        ...
        solution_127: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_11(info, 350, 0, pos, cc.v2(0.3906, 0), cc.v2(0.3906, 0.132), 0, 0.5);
        },
        ...
        solution_129: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_11(info, 450, 0, pos, cc.v2(0.9219, 0), cc.v2(0.9219, 0.1849), 0, 0.5);
        },
        ...
        solution_131: function (info, skills) {
            ...
            let pos_1 = info.pos;
            let vec_1 = ai.posTransfer(pos_1);
            let vec_2 = ai.posTransfer(pos_1.add(cc.v2(0.1953, -0.184)));
            let vec_3 = ai.posTransfer(pos_1.add(cc.v2(0.4672, -0.184)));
            entity.setRotation(-130);
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    let posData = [vec_1, vec_2, vec_3];
        ...
        solution_133: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_11(info, 300, 0, pos, cc.v2(0.3906, 0), cc.v2(0.3906, -0.132), 1, 0.5);
        },
        ...
        solution_135: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_11(info, 450, 0, pos, cc.v2(0.9219, 0), cc.v2(0.9219, -0.1849), 1, 0.5);
        },
        ...
        solution_137: function (info, skills) {
            let ai = require('AIInterface');
            let vec = ai.posTransfer(info.pos.add(cc.v2(0.9688, 0)));
            return MonsterSolutions.solution_3(info, vec, 2, 50, 0, 3);
        },
        ...
        solution_141: function (info, skills) {
            let ai = require('AIInterface');
            let vec = ai.posTransfer(info.pos.add(cc.v2(0, -0.6162)));
            return MonsterSolutions.solution_3(info, vec, 2, 50, 0, 3);
        },
        solution_142: function (info, skills) {
            let ai = require('AIInterface');
            let vec = ai.posTransfer(info.pos.add(cc.v2(0, -0.3521)));
            return MonsterSolutions.solution_3(info, vec, 2, 50, 0, 3);
        },
        solution_143: function (info, skills) {
            let ai = require('AIInterface');
            let vec = ai.posTransfer(info.pos.add(cc.v2(0.9688, 0.2729)));
            return MonsterSolutions.solution_3(info, vec, 2, 50, 0, 3);
        },
        ...
        solution_145: function (info, skills) {
            let ai = require('AIInterface');
            let vec = ai.posTransfer(info.pos.add(cc.v2(0.5, 0.1408)));
            return MonsterSolutions.solution_3(info, vec, 2, 50, 0, 3);
        },
        ...
        solution_149: function (info, skills) {
            let ai = require('AIInterface');
            let vec = ai.posTransfer(info.pos.add(cc.v2(0.5, -0.1409)));
            return MonsterSolutions.solution_3(info, vec, 2, 50, 0, 3);
        },
        ...
        solution_151: function (info, skills) {
            let ai = require('AIInterface');
            let vec = ai.posTransfer(info.pos.add(cc.v2(0.4688, 0)));
        ...
        solution_153: function (info, skills) {
            ...
            entity.setTimerHandler(function (idx) {
                if (idx == 0) {
                    this.setSpeed(cc.v2(0, -250), false);
                }
                if (idx == 1) {
                    this.setSpeed(ai.speedTransfer(250, -130), false);
                }
                if (idx == 2) {
                    this.setSpeed(cc.v2(0, 0), false);
                }
                if (idx == 3) {
                    ai.autoUseSkill(this, true);
                }
        ...
        solution_157: function (info, skills) {
            return MonsterSolutions.solution_16(info, 400, 0, 0, 1);
        },
        solution_158: function (info, skills) {
            return MonsterSolutions.solution_1(info, 400, -90, 0, 0, 0);
        },
        solution_159: function (info, skills) {
            return MonsterSolutions.solution_65(info, 1.2, 80);
        },
        ...
        solution_163: function (info, skills) {
            let pos = info.pos;
            return MonsterSolutions.solution_5(info, 350, 0, pos, cc.v2(0.625, 0.3521), cc.v2(1.25,0), 1, 1);
        },
